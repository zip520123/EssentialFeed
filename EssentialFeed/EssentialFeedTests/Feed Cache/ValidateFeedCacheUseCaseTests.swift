...
class ValidateFeedCacheUseCaseTests: XCTestCase {
    ...
    private func expect(_ sut: LocalFeedLoader, toCompleteWith expectedResult: LocalFeedLoader.ValidationResult, when action: ()->(), file: StaticString = #file, line: UInt = #line) {
